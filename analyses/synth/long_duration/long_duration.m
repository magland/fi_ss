...
M=mda_size(1);
N=mda_size(2);
segment_duration=30000*60*60*0.5;
segments={};
for t=0:segment_duration:max(0,N-segment_duration)
...
mp_run_process('mountainsort.combine_firing_segments',...
        ...
        struct('match_score_threshold','0.6'));

% mp_run_process('mountainsort.combine_fir7ings',...
